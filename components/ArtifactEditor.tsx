  ...
  return (
    <div>
      ...
      <textarea
        ...
        className="w-full rounded-md border border-stone-300 px-3 py-2 text-sm text-stone-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-600"
      />
